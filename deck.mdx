...
<CodeSurfer
  ...
  steps={[
    ...
    { lines: [11], notes: "" },
    { range: [13, 15], notes: "" },
    { tokens: { 5: [8, 9, 10, 11, 12] }, notes: "+, infix" },
    {},
  ]}
/>
...
men inte superlätt att arbeta med
```
...
<CodeSurfer
  title="Tillbaka till mängdläran"
...
```notes
simpelt att fånga varje fall

autocomplete, data finns bara på Loaded!
```
...
<Appear>
  ...
  <div>Polymorphism</div>
  <div>Mängdlära, Unioner, Produkter och Summor</div>
</Appear>
